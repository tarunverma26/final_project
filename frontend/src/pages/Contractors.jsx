...
function Stars({ value }) {
  if (value == null) return <span className="text-zinc-500 italic text-xs">No ratings yet</span>;
  ...
  return (
    <div className="flex items-center gap-0.5">
      ...
      <span className="text-xs text-zinc-400 ml-1 font-mono">{value.toFixed(2)}</span>
    </div>
  );
}
