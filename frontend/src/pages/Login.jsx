...
import { UserCircle, ShieldCheck, Warning, ArrowRight, ShieldStar } from "@phosphor-icons/react";
      ...
      <div className="relative z-10 min-h-screen flex items-center">
        <div className="w-full max-w-6xl mx-auto grid md:grid-cols-[1fr_minmax(340px,460px)_1fr] items-center gap-6 md:gap-8 px-6 py-20">
          ...
          >
            ...
            >
              {busy ? "Signing in..." : <><span>Sign In to ROADWATCH</span> <ArrowRight size={16} weight="bold" /></>}
            </button>
            ...
            {role === "admin" && (
              <div className="mt-3 text-center">
                <Link
                  to="/admin/login"
                  className="text-xs font-mono font-semibold text-[#0F766E] hover:underline"
                >
            ...
            <div className="mt-5 pt-4 border-t border-[#F1F5F9] text-center text-xs text-[#64748B]">
              {role === "admin" ? (
                <>
                  ...
                  <Link to="/admin/register" className="text-[#F97316] font-semibold hover:underline" data-testid="login-admin-register-link">
                ...
                <>
                  New citizen?{" "}
                  <Link to="/register" className="text-[#F97316] font-semibold hover:underline" data-testid="login-register-link">
  ...
  return (
    ...
    >
      <div className={`w-12 h-12 mx-auto rounded-xl flex items-center justify-center border ${
        active ? "bg-orange-50 border-orange-200 text-[#F97316]" : "bg-slate-100 border-slate-200 text-[#64748B]"
      }`}>
      ...
      <div className={`mt-4 inline-flex items-center gap-1.5 text-[10px] font-mono font-bold px-2.5 py-1 rounded-full ${
        active ? "bg-orange-50 text-[#EA580C] border border-orange-200" : "bg-slate-100 text-[#64748B]"
      }`}>
